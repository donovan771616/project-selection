(function () {
    ...
    function barOption(title, series, horizontal) {
        const labels = series && series.labels ? series.labels : [];
        const values = series && series.values ? series.values : [];
        const axisLabel = {color: "#64748b", interval: 0};
        return {
            color: [palette[0]],
            tooltip: {
                trigger: "axis",
            ...
            grid: {top: 24, right: 22, bottom: horizontal ? 18 : 48, left: horizontal ? 94 : 36, containLabel: true},
            xAxis: horizontal
            ...
            yAxis: horizontal
                ...
                : {type: "value", axisLabel: axisLabel, splitLine: {lineStyle: {color: "#e8eef7"}}},
            series: [{
                name: title, type: "bar", barMaxWidth: 32,
    ...
    function gaugeOption(title, series) {
        ...
        return {
            ...
            series: [{
                name: title, type: "gauge", center: ["50%", "58%"], radius: "78%",
                ...
                axisLine: {lineStyle: {width: 14, roundCap: true}},
                axisTick: {show: false},
                splitLine: {length: 8, lineStyle: {width: 1, color: "#fff"}},
                axisLabel: {distance: 20, color: "#64748b", formatter: "{value}%"},
                anchor: {show: true, showAbove: true, size: 10, itemStyle: {borderWidth: 2, color: palette[1]}},
                title: {show: false},
                detail: {
                    valueAnimation: true, fontSize: 28, fontWeight: "600",
                    offsetCenter: [0, "30%"],
    ...
    function renderChart(config) {
        ...
        if (!container || !window.echarts) {
            if (container) showEmpty(container);
            return null;
        }
